...
public class ThreadPoolTCPServer {
    ...
    public ThreadPoolTCPServer(int port) {
        this.port = port;
        this.threadPool = Executors.newFixedThreadPool(10); // max 10 clients simultanés
    }
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            while (running) {
                ...
                threadPool.execute(() -> {
                    ...
                    handler.run(); // exécute le client dans le thread pool
                });
            }
    ...
    public static void main(String[] args) {
        ...
        // Thread pour arrêter le serveur après un certain temps (optionnel)
